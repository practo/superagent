...
/**
 * Expose cid generation function.
 */
...
/**
 * Expose mutate with cid to insert cid in a given header.
 */

exports.mutateWithCid = function(headers) {
  if (!headers.Cid && !headers.cid) {
    headers.Cid = newCid();
  }
}

/**
 * Expose extract cid from headers.
 */

exports.extractCid = function(headers) {
  return headers.Cid || headers.cid || newCid();
}
...
/**
 * Do not attach Cid to the request header.
 */

Request.prototype.noCid = function() {
  this._noCid = true;
  return this;
}

/**
 * Set a Cid to the request header.
 */

Request.prototype.setCid = function(cid) {
  this.request().setHeader('Cid', cid);
  return this;
}
...
Request.prototype.end = function(fn){
  ...
  if ('HEAD' != method && !req._headerSent) {
    ...
    // If no Cid in the header, generate and add a new cid
    if (!this._noCid && !req.getHeader('Cid') && !req.getHeader('cid')) {
      req.setHeader('Cid', newCid());
    }
  }
